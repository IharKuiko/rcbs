...
@section('title', 'Герои Советского Союза – земляки')
...
@section('content')
    ...
    <div class="cards md:w-3/4 p-4">
        ...
        <h2 class="text-center text-4xl text-textcol font-semibold">Герои Советского Союза – земляки</h2>
        <br>
        <p>
            Герои Советского Союза – земляки
        </p>
        <br>
        <hr>
        <br>
