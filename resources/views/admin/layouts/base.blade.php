...
{{--                            <img src="{{ Vite::asset('resources/admin/img/user1-128x128.jpg') }}" alt="User Avatar"--}}
{{--                                 class="img-size-50 mr-3 img-circle">--}}
...
{{--    </nav>--}}
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ url('/') }}" target="_blank" class="brand-link">
            <img src="{{ Vite::asset('resources/assets/admin/img/AdminLTELogo.png') }}"
                 alt="AdminLTE Logo"
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{ Vite::asset('resources/assets/admin/img/user2-160x160.jpg') }}" class="img-circle elevation-2"
                         alt="User Image">
                </div>
                <div class="info">
...
{{--                                </a>--}}
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-{{ date('Y') }} <a href="http://adminlte.io">KITech</a>.</strong> All rights
        reserved.
    </footer>
