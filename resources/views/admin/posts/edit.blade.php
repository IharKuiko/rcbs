                        ...
                        <form role="form" method="post" action="{{ route('posts.update', ['post' => $post->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div><img src="{{ $post->getImage() }}" alt="" class="img-thumbnail mt-5" width="200">{{ $post->getImage() }}</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-checkbox">
                                            <input type="checkbox" name="is_published" id="is_published" class="" {{ $post->is_published == 1 ? ' checked' : '' }}>
